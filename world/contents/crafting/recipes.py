...
RECIPES = {
    "battleaxe": {
        ...
        "desc": "Made of {material} this axe has a double blade with a thick|/ "
                "center which allows it to cut in both directions while bashing|/ "
                "an enemy with the thick center. The haft is also made of {material}|/"
                "with a leather grip. Finely crafted by {crafter} at the forge.",
        "weight": 6.0,
        "value": 1000*CP,
        "damage_roll": "1d8",
        "crit_mod": 3,
