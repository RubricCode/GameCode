...
who caliphate  - Lists all the players who started in the caliphate.
who empire  - Lists all the players who started in the empire
who guides - Lists all active guides.
who <race> - Lists all the players with this specific race.
    ...
    def func(self):
        ...
        self.caller.msg("    Roy, |305Administrator|n ")
