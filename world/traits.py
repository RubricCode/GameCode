...
_TRAIT_CLASS_PATHS = [
    "mygame.world.traits.Trait",
    "mygame.world.traits.StaticTrait",
    "mygame.world.traits.CounterTrait",
    "mygame.world.traits.GaugeTrait",
]
...
class StaticTrait(Trait):
    ...
    def __str__(self):
        ...
        return "{name:12} {status} ({mod:+3}) (* {mult:.2f})".format(name=self.name, status=status, mod=self.mod,
                                                                     mult=self.mult)
